    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#profileExamples" class="nav-link text-dark active" aria-controls="profileExamples" role="button" aria-expanded="false">
                    ...
                    <div class="collapse  show " id="profileExamples">
                        <ul class="nav ">
                            <li class="nav-item ">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link text-dark active" href="../../pages/team/messages.html">
